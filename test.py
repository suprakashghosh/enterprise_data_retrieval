...
pipeline_options.picture_description_options = (
    granite_picture_description  # Can also be smolvlm_picture_description
)
...
# %load_ext autoreload
# %autoreload 2
chunk_metadatas, text_lookup, pic_table_lookup = build_chunk_metadata_list(
    conv_result=conv_result, output_dir=output_dir
)
chunk_metadatas_with_refers_to = resolve_cross_references(
...
enriched = populate_relates_to(
    chunk_metadatas_with_refers_to,
    embeddings_2d,
    top_k=3,
    document_name=conv_result.document.origin.filename,
    output_dir=output_dir,
